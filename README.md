...
[![NPM version](https://img.shields.io/npm/v/whatsauto.svg)](https://npmjs.org/package/whatsauto) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/whatsauto)
...
<!-- prettier-ignore -->
```js
import Petstore from 'whatsauto';
